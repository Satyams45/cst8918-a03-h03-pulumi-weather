# Base node image with a pinned version for reproducibility
...
# Set NODE_ENV for base and all layers
...
# Production stage: build the final image with a minimal footprint
